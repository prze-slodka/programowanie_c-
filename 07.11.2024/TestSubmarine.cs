                    ...
                    try
                    {
                        ...
                        if (instance != null && oxygen!= null && food != null)
                        {
                            ...
                            if ((bool)method.Invoke(instance, new object[] { 1.0 }))
                            {
                                failed++;
                                Console.ForegroundColor = ConsoleColor.Red;
                                Console.WriteLine("Test " + testNumber + " failed: CheckSuppliesBeforeTravel returned true despite no oxygen.");
                            }
                            else
                            {
                                Console.ForegroundColor = ConsoleColor.Green;
                            ...
                            {
                                Console.ForegroundColor = ConsoleColor.Green;
                                Console.WriteLine("Test " + testNumber + " passed: Travel method correctly updated oxygen, food and waste values.");
                            }
                            else
                            {
                                failed++;
                                Console.ForegroundColor = ConsoleColor.Red;
                                Console.WriteLine("Test " + testNumber + " failed: Travel method did not decrease oxygen" +
